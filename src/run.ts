...
import AppConfig from 'clever-tools/src/models/app_configuration.js'
import git from 'clever-tools/src/models/git.js'

export async function run(): Promise<void> {
    const applicationId = core.getInput('application_id')
    ...
    core.info(`Deploying your application (${applicationId}) on CleverCloud...`)
    ...
    core.info('Deploy order has been queued')
    // fetch logs
}
