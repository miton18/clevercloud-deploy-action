...
exports.todo_replaceApplicationTags = todo_replaceApplicationTags;
exports.todo_getNewSetupIntentByOrga = todo_getNewSetupIntentByOrga;
exports.todo_getStripeTokenByOrga = todo_getStripeTokenByOrga;
...
exports.todo_getUserById = todo_getUserById;
exports.todo_getApplications = todo_getApplications;
exports.todo_getGitInfo = todo_getGitInfo;
...
function todo_authorizeForm(params) {
  ...
  return Promise.resolve({
    ...
    queryParams: (0, _pickNonNull.pickNonNull)(params, ['oauth_token', 'ccid', 'cli_token', 'from_oauth']) // no body
...
function todo_replaceApplicationTags(params, body) {
...
function todo_getNewSetupIntentByOrga(params) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'get',
...
function todo_getStripeTokenByOrga(params) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'get',
...
function todo_getUserById(params) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'get',
...
function todo_getApplications(params) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'get',
...
function todo_getGitInfo(params) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'get',
