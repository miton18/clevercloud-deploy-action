 ...
 * @param {Object} body
 */
export function listNetworkGroups(params, body) {
 ...
 * @param {Object} body
 */
export function deleteNetworkGroup(params, body) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'delete',
 ...
 * @param {Object} body
 */
export function getNetworkGroup(params, body) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'get',
    url: `/v4/networkgroups/organisations/${params.ownerId}/networkgroups/${params.networkGroupId}`,
 ...
 * @param {Object} body
 */
export function deleteNetworkGroupExternalPeer(params, body) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'delete',
 ...
 * @param {Object} body
 */
export function listNetworkGroupMembers(params, body) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'get',
 ...
 * @param {Object} body
 */
export function deleteNetworkGroupMember(params, body) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'delete',
 ...
 * @param {Object} body
 */
export function getNetworkGroupMember(params, body) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'get',
    url: `/v4/networkgroups/organisations/${params.ownerId}/networkgroups/${params.networkGroupId}/members/${params.memberId}`,
 ...
 * @param {Object} body
 */
export function listNetworkGroupPeers(params, body) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'get',
 ...
 * @param {Object} body
 */
export function deleteNetworkGroupPeer(params, body) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'delete',
 ...
 * @param {Object} body
 */
export function getNetworkGroupPeer(params, body) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'get',
    url: `/v4/networkgroups/organisations/${params.ownerId}/networkgroups/${params.networkGroupId}/peers/${params.peerId}`,
 ...
 * @param {Object} body
 */
export function getNetworkGroupWireGuardConfiguration(params, body) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'get',
 ...
 * @param {Object} body
 */
export function getNetworkGroupWireGuardConfigurationStream(params, body) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'get',
 ...
 * @param {Object} body
 */
export function getNetworkGroupStream(params, body) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'get',
