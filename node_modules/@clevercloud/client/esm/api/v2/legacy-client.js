...
export function initLegacyClient(prepareRequest) {
  const client = {
      ...
      _: {
        ...
        applications: {
          ...
          _: {
            ...
            tags: {
              ...
              put: prepareRequest(unknown.todo_replaceApplicationTags, ['id', 'appId']),
              _: {
        ...
        payments: {
          ...
          methods: {
            ...
            newintent: {
              get: prepareRequest(unknown.todo_getNewSetupIntentByOrga, ['id']),
            },
          },
          monthlyinvoice: {
          ...
          tokens: {
            stripe: {
              get: prepareRequest(unknown.todo_getStripeTokenByOrga, ['id']),
            },
          },
        },
      },
    ...
    self: {
      ...
      mfa: {
        _: {
          delete: prepareRequest(user.todo_deleteMFA, ['kind']),
          post: prepareRequest(user.todo_createMFA, ['kind']),
          put: prepareRequest(user.todo_favMFA, ['kind']),
          backupcodes: {
            get: prepareRequest(user.todo_getBackupCodes, ['kind']),
          },
          confirmation: {
            post: prepareRequest(user.todo_validateMFA, ['kind']),
          },
        },
      },
      'payment-info': {
      ...
      tokens: {
        delete: prepareRequest(user.todo_revokeAllTokens),
        get: prepareRequest(user.todo_getSelfTokens),
        _: {
          delete: prepareRequest(user.todo_revokeToken, ['token']),
        },
      },
      validate_email: {
    ...
    users: {
      ...
      _: {
        get: prepareRequest(unknown.todo_getUserById, ['id']),
        applications: {
          get: prepareRequest(unknown.todo_getApplications, ['id']),
        },
        'git-info': {
          get: prepareRequest(unknown.todo_getGitInfo, ['userId']),
        },
      },
    },
    validation: {
