 ...
 */
export function todo_deleteMFA(params) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'delete',
 ...
 * @param {String} params.kind
 */
export function todo_createMFA(params) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'post',
    url: `/v2/self/mfa/${params.kind}`,
 ...
 * @param {Object} body
 */
export function todo_favMFA(params, body) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'put',
    url: `/v2/self/mfa/${params.kind}`,
 ...
 * @param {String} params.kind
 */
export function todo_getBackupCodes(params) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'get',
 ...
 * @param {Object} body
 */
export function todo_validateMFA(params, body) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'post',
 ...
 * @param {Object} params
 */
export function todo_revokeAllTokens() {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'delete',
    url: `/v2/self/tokens`,
 ...
 * @param {Object} params
 */
export function todo_getSelfTokens() {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'get',
    url: `/v2/self/tokens`,
 ...
 */
export function todo_revokeToken(params) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'delete',
