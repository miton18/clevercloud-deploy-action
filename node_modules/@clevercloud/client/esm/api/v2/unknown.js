...
export function todo_authorizeForm(params) {
  ...
  return Promise.resolve({
    ...
    headers: { Accept: 'application/json' },
    queryParams: pickNonNull(params, ['oauth_token', 'ccid', 'cli_token', 'from_oauth']),
    // no body
  });
}
 ...
 * @param {Object} body
 */
export function todo_replaceApplicationTags(params, body) {
 ...
 */
export function todo_getNewSetupIntentByOrga(params) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'get',
 ...
 * @param {String} params.id
 */
export function todo_getStripeTokenByOrga(params) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'get',
 ...
 * @param {String} params.id
 */
export function todo_getUserById(params) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'get',
 ...
 * @param {String} params.id
 */
export function todo_getApplications(params) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'get',
 ...
 */
export function todo_getGitInfo(params) {
  // no multipath for /self or /organisations/{id}
  return Promise.resolve({
    method: 'get',
